...
from .models import computer_science_dept_lab_facilities, computer_science_dept_major_equipments
...
def faculty(request,course,dept):
    ...
    if course == 'UG' and dept =='BT':
        ...
        for faculty_data in faculties_data:
            print(faculty_data.name,faculty_data.designation,faculty_data.image,faculty_data.detail)
...
def home(request,course,dept):
    print(dept)
    return render(request,'department/'+course+'/'+ dept +'/home.html')
